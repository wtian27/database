...
public class OrderForm extends JFrame {
	...
	public OrderForm() {
		...
		lblCheesePizza.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblGompeisPizza = new JLabel("GOMPEI'S PIZZA");
		lblGompeisPizza.setFont(new Font("宋体", Font.BOLD, 18));
		...
		lblPepporaniPizza.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblHawaiiPizza = new JLabel("Hawaii Pizza");
		lblHawaiiPizza.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblShaqPizza = new JLabel("Shaq Pizza");
		lblShaqPizza.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblCalzoneWithVegetables = new JLabel("Calzone with Vege");
		lblCalzoneWithVegetables.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblCalzoneWithMeat = new JLabel("Calzone with Meat");
		lblCalzoneWithMeat.setFont(new Font("宋体", Font.PLAIN, 14));

		JLabel lblSmall = new JLabel("Small");
		lblSmall.setFont(new Font("宋体", Font.BOLD, 15));

		JLabel lblLarge = new JLabel("Large");
		lblLarge.setFont(new Font("宋体", Font.BOLD, 16));
